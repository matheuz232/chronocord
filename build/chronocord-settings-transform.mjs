export function chronocordSettingsCenter() {
  return {
    ...
    transform(code, id) {
      ...
      const apiImportLine = "import { createAccountApi } from './settings/accountApi.js';";
      if (!output.includes(importLine)) output = `${importLine}\n${output}`;
      if (!output.includes(apiImportLine)) output = `${apiImportLine}\n${output}`;
